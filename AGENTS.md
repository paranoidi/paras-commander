...
- **`internal/app/shell_host.go`**: shared `appShellHost` embedded by `jobs_host.go`, `find_host.go`, `meta_host.go`, `commands_host.go`, and `preview_host.go`.
