...
func TestFindDialogNavFocusKey(t *testing.T) {
	...
	for _, tt := range []row{
		...
		{6, false, tcell.KeyTab, 0, true},
		{1, false, tcell.KeyRight, 2, true},
		{2, false, tcell.KeyRight, 3, true},
		{3, false, tcell.KeyRight, 4, true},
		{4, false, tcell.KeyLeft, 3, true},
		{3, false, tcell.KeyLeft, 2, true},
		{2, false, tcell.KeyLeft, 1, true},
		{1, false, tcell.KeyDown, 5, true},
		{2, false, tcell.KeyDown, 5, true},
		{3, false, tcell.KeyDown, 5, true},
		{4, false, tcell.KeyDown, 5, true},
		{1, false, tcell.KeyUp, 0, true},
		{2, false, tcell.KeyUp, 0, true},
		{3, false, tcell.KeyUp, 0, true},
		{4, false, tcell.KeyUp, 0, true},
		{5, false, tcell.KeyUp, 4, true},
		{6, false, tcell.KeyUp, 4, true},
		{0, false, tcell.KeyDown, 0, false},
		{0, true, tcell.KeyTab, 1, true},
		{7, true, tcell.KeyTab, 0, true},
		{1, true, tcell.KeyRight, 2, true},
		{2, true, tcell.KeyRight, 3, true},
		{3, true, tcell.KeyRight, 4, true},
		{3, true, tcell.KeyLeft, 2, true},
		{1, true, tcell.KeyDown, 5, true},
		{2, true, tcell.KeyDown, 5, true},
		{3, true, tcell.KeyDown, 5, true},
		{4, true, tcell.KeyDown, 5, true},
		{5, true, tcell.KeyDown, 6, true},
		{4, true, tcell.KeyUp, 0, true},
		{5, true, tcell.KeyUp, 4, true},
		{6, true, tcell.KeyUp, 5, true},
		{7, true, tcell.KeyUp, 5, true},
	} {
