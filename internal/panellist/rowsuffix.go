...
// internal/panelcarousel/draw.go drawCarouselColumn: both compute a job icon, new-file tier,
...
func NewRowSuffix(jobIcon rune, tier NewFileMarkTier, renameMark, subtreeMark, jobWrite bool) RowSuffix {
	return RowSuffix{
		JobIcon:          jobIcon,
		NewFileTier:      tier,
